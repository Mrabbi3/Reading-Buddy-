import React, { useState as useWL, useEffect as useWLE, useRef as useWLRef } from 'react';
import { useRouter } from 'expo-router';
import { Ic, RBMark } from '../src/components/web/icons';
...
function WLNav({ onLogin, onStart, onGoto, session }) {
  return (
    <nav className="wl-nav">
      <div className="wl-nav-in">
        ...
        <div className="wl-nav-cta">
          {session ? (
             <button className="wl-start" onClick={onStart}>Open Library</button>
          ) : (
            <>
      ...
      <div className="wl-stagewrap">
        {heroImage !== false && (
          <div className="wl-heroimg" style={{ background: 'linear-gradient(150deg, #2a2418, #17150F)' }}>
            <img src={"/assets/web/images/web-hero.png"} alt="A reading corner at dusk" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          </div>
        )}
    ...
    <section className="ink-sec grain-w" id="wl-ios">
      <div className="wl-ios">
        <div className="wl-ios-img" style={{ background: 'linear-gradient(150deg, #2a2418, #17150F)' }}>
            <img src={"/assets/web/images/ios-promo.png"} alt="Reading by lamplight with the Reading Buddy iOS app" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
        </div>
        <div>
...
export default function WebLanding() {
  ...
  return (
    <div className="grain-w" style={{ background: 'var(--paper)', minHeight: '100vh', width: '100%' }}>
      <WLNav onLogin={onLogin} onStart={onStart} onGoto={goto} session={session} />
      <div style={{ position: 'relative', zIndex: 1 }}>
        <WLHero onStart={onStart} onToast={onToast} heroImage={true} />
