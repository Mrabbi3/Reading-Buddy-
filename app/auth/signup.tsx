  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Join Reading Buddy today</Text>
      </View>
      <View style={styles.form}>
        ...
        <PrimaryButton title={loading ? 'Creating…' : 'Sign Up'} onPress={handleSignup} style={{ marginTop: 8, marginBottom: 24 }} />
